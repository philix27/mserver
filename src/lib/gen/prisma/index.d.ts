...
export type CurrencyFiat = (typeof CurrencyFiat)[keyof typeof CurrencyFiat]
...
export type CurrencyCrypto = $Enums.CurrencyCrypto

export const CurrencyCrypto: typeof $Enums.CurrencyCrypto

export type CurrencyFiat = $Enums.CurrencyFiat

export const CurrencyFiat: typeof $Enums.CurrencyFiat
...
export type BankName = $Enums.BankName

export const BankName: typeof $Enums.BankName
...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "firstname" | "lastname" | "middlename" | "email" | "password" | "transaction_pin" | "role" | "country" | "created_at" | "updated_at" | "bvn" | "bvn_status" | "nin" | "nin_status" | "home_address" | "phone" | "phone_verified" | "merchant_success_rate" | "merchant_trade_count" | "merchant_nickname" | "merchant_status", ExtArgs["result"]["user"]>
  ...
  export type BankAccountOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "account_name" | "account_no" | "soft_delete" | "bank_name" | "created_at" | "updated_at" | "user_id", ExtArgs["result"]["bankAccount"]>
  ...
  interface BankAccountFieldRefs {
    ...
    readonly bank_name: FieldRef<"BankAccount", 'BankName'>
  ...
  export type AdvertsMinAggregateOutputType = {
    ...
    currency_crypto: $Enums.CurrencyCrypto | null
    currency_fiat: $Enums.CurrencyFiat | null
  ...
  interface AdvertsFieldRefs {
    ...
    readonly currency_crypto: FieldRef<"Adverts", 'CurrencyCrypto'>
    readonly currency_fiat: FieldRef<"Adverts", 'CurrencyFiat'>
  ...
  export type OrdersOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "amount_fiat" | "amount_crypto" | "wallet_customer" | "wallet_merchant" | "estimated_duration" | "bank_account_name" | "bank_account_no" | "bank_name" | "currency_crypto" | "currency_fiat" | "trade_type" | "status" | "action_user" | "action_merchant" | "sell_txn_hash_customer_lock_crypto" | "sell_txn_hash_customer_release_crypto" | "sell_time2_customer_lock_crypto" | "sell_time1_customer_request" | "sell_time3_merchant_send_fiat" | "sell_time4_customer_release_crypto" | "buy_time1_customer_request" | "buy_time2_merchant_lock_crypto" | "buy_time3_customer_send_fiat" | "buy_time4_merchant_release_crypto" | "buy_txn_hash_merchant_lock_crypto" | "buy_txn_hash_merchant_release_crypto" | "created_at" | "updated_at" | "customer_id" | "merchant_id", ExtArgs["result"]["orders"]>
  ...
  interface OrdersFieldRefs {
    ...
    readonly bank_account_name: FieldRef<"Orders", 'String'>
    readonly bank_account_no: FieldRef<"Orders", 'String'>
    readonly bank_name: FieldRef<"Orders", 'BankName'>
    readonly currency_crypto: FieldRef<"Orders", 'CurrencyCrypto'>
    readonly currency_fiat: FieldRef<"Orders", 'CurrencyFiat'>
  ...
  export type TransactionsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "amount" | "note" | "category" | "mode" | "status" | "created_at" | "updated_at" | "user_id", ExtArgs["result"]["transactions"]>
  ...
  /**
   * Reference to a field of type 'CurrencyCrypto'
   */
  export type EnumCurrencyCryptoFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'CurrencyCrypto'>
   ...
   * Reference to a field of type 'CurrencyCrypto[]'
   */
  export type ListEnumCurrencyCryptoFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'CurrencyCrypto[]'>
    


  /**
   * Reference to a field of type 'CurrencyFiat'
   */
  export type EnumCurrencyFiatFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'CurrencyFiat'>
   ...
   * Reference to a field of type 'CurrencyFiat[]'
   */
  export type ListEnumCurrencyFiatFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'CurrencyFiat[]'>
  ...
  export type BankAccountWhereInput = {
    ...
    bank_name?: EnumBankNameFilter<"BankAccount"> | $Enums.BankName
  ...
  export type BankAccountScalarWhereWithAggregatesInput = {
    ...
    bank_name?: EnumBankNameWithAggregatesFilter<"BankAccount"> | $Enums.BankName
  ...
  export type AdvertsWhereInput = {
    ...
    currency_crypto?: EnumCurrencyCryptoFilter<"Adverts"> | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatFilter<"Adverts"> | $Enums.CurrencyFiat
  ...
  export type AdvertsScalarWhereWithAggregatesInput = {
    ...
    currency_crypto?: EnumCurrencyCryptoWithAggregatesFilter<"Adverts"> | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatWithAggregatesFilter<"Adverts"> | $Enums.CurrencyFiat
  ...
  export type OrdersWhereInput = {
    ...
    bank_account_name?: StringFilter<"Orders"> | string
    bank_account_no?: StringFilter<"Orders"> | string
    bank_name?: EnumBankNameFilter<"Orders"> | $Enums.BankName
    currency_crypto?: EnumCurrencyCryptoFilter<"Orders"> | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatFilter<"Orders"> | $Enums.CurrencyFiat
  ...
  export type OrdersScalarWhereWithAggregatesInput = {
    ...
    bank_account_name?: StringWithAggregatesFilter<"Orders"> | string
    bank_account_no?: StringWithAggregatesFilter<"Orders"> | string
    bank_name?: EnumBankNameWithAggregatesFilter<"Orders"> | $Enums.BankName
    currency_crypto?: EnumCurrencyCryptoWithAggregatesFilter<"Orders"> | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatWithAggregatesFilter<"Orders"> | $Enums.CurrencyFiat
  ...
  export type BankAccountUpdateInput = {
    ...
    bank_name?: EnumBankNameFieldUpdateOperationsInput | $Enums.BankName
    created_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    updated_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  ...
  export type AdvertsUpdateInput = {
    ...
    currency_crypto?: EnumCurrencyCryptoFieldUpdateOperationsInput | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatFieldUpdateOperationsInput | $Enums.CurrencyFiat
  ...
  export type OrdersUpdateInput = {
    ...
    bank_account_no?: StringFieldUpdateOperationsInput | string
    bank_name?: EnumBankNameFieldUpdateOperationsInput | $Enums.BankName
    currency_crypto?: EnumCurrencyCryptoFieldUpdateOperationsInput | $Enums.CurrencyCrypto
    currency_fiat?: EnumCurrencyFiatFieldUpdateOperationsInput | $Enums.CurrencyFiat
  ...
  export type EnumBankNameFilter<$PrismaModel = never> = {
    equals?: $Enums.BankName | EnumBankNameFieldRefInput<$PrismaModel>
    in?: $Enums.BankName[] | ListEnumBankNameFieldRefInput<$PrismaModel>
    notIn?: $Enums.BankName[] | ListEnumBankNameFieldRefInput<$PrismaModel>
    not?: NestedEnumBankNameFilter<$PrismaModel> | $Enums.BankName
  }
  ...
  export type EnumBankNameWithAggregatesFilter<$PrismaModel = never> = {
    ...
    in?: $Enums.BankName[] | ListEnumBankNameFieldRefInput<$PrismaModel>
    notIn?: $Enums.BankName[] | ListEnumBankNameFieldRefInput<$PrismaModel>
    not?: NestedEnumBankNameWithAggregatesFilter<$PrismaModel> | $Enums.BankName
    _count?: NestedIntFilter<$PrismaModel>
    _min?: NestedEnumBankNameFilter<$PrismaModel>
    _max?: NestedEnumBankNameFilter<$PrismaModel>
  }
  ...
  export type EnumCurrencyCryptoFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyCrypto | EnumCurrencyCryptoFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyCryptoFilter<$PrismaModel> | $Enums.CurrencyCrypto
  }

  export type EnumCurrencyFiatFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyFiat | EnumCurrencyFiatFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyFiatFilter<$PrismaModel> | $Enums.CurrencyFiat
  }
  ...
  export type EnumCurrencyCryptoWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyCrypto | EnumCurrencyCryptoFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyCryptoWithAggregatesFilter<$PrismaModel> | $Enums.CurrencyCrypto
    _count?: NestedIntFilter<$PrismaModel>
    _min?: NestedEnumCurrencyCryptoFilter<$PrismaModel>
    _max?: NestedEnumCurrencyCryptoFilter<$PrismaModel>
  }

  export type EnumCurrencyFiatWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyFiat | EnumCurrencyFiatFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyFiatWithAggregatesFilter<$PrismaModel> | $Enums.CurrencyFiat
    _count?: NestedIntFilter<$PrismaModel>
    _min?: NestedEnumCurrencyFiatFilter<$PrismaModel>
    _max?: NestedEnumCurrencyFiatFilter<$PrismaModel>
  }
  ...
  export type EnumBankNameFieldUpdateOperationsInput = {
    set?: $Enums.BankName
  }
  ...
  export type EnumCurrencyCryptoFieldUpdateOperationsInput = {
    set?: $Enums.CurrencyCrypto
  }

  export type EnumCurrencyFiatFieldUpdateOperationsInput = {
    set?: $Enums.CurrencyFiat
  }
  ...
  export type NestedEnumCurrencyCryptoFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyCrypto | EnumCurrencyCryptoFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyCryptoFilter<$PrismaModel> | $Enums.CurrencyCrypto
  ...
  export type NestedEnumCurrencyFiatFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyFiat | EnumCurrencyFiatFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyFiatFilter<$PrismaModel> | $Enums.CurrencyFiat
  ...
  export type NestedEnumCurrencyCryptoWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyCrypto | EnumCurrencyCryptoFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyCrypto[] | ListEnumCurrencyCryptoFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyCryptoWithAggregatesFilter<$PrismaModel> | $Enums.CurrencyCrypto
  ...
  export type NestedEnumCurrencyFiatWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.CurrencyFiat | EnumCurrencyFiatFieldRefInput<$PrismaModel>
    in?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    notIn?: $Enums.CurrencyFiat[] | ListEnumCurrencyFiatFieldRefInput<$PrismaModel>
    not?: NestedEnumCurrencyFiatWithAggregatesFilter<$PrismaModel> | $Enums.CurrencyFiat
